...
def register_student():
    ...
    def submit_registration():
        ...
        if name and roll_number:
            ...
            img_path = '/4-1P/UI/0001.png'  # Path to your image
...
def main_window():
    ...
    img_path1 = '/4-1P/UI/register.png'  # Path to your first image
    ...
    img_path2 = '/4-1P/UI/attendance.png'  # Path to your second image
    ...
    img_path3 = '/4-1P/UI/verifyy.png'  # Path to your third image
